  ...
  return (
    <div className="space-y-6">
      ...
      <p className="text-sm text-slate-500 dark:text-slate-400">
        ...
        <code className="text-xs">logging.file</code> (relative paths resolve from the devices-mcp repo root).
        Uvicorn-only lines may still appear in the terminal; file logging must be enabled for the backend process.
      </p>
      {error && (
