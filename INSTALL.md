...
4. Start the server:
   ...
   uv run python -m devices_mcp.server

   # HTTP mode (for web dashboard)
   uv run uvicorn devices_mcp.server:app --port 10717
   ```
5. Open `http://localhost:10717` or the frontend URL.
...
| Something else | [Open a GitHub issue](https://github.com/sandraschi/devices-mcp/issues) |
