        ...
        try:
            ...
            if action == "print_label":
                if not text:
                    return {
                        "success": False,
                        "message": "text is required for print_label action",
            ...
            if action == "print_batch":
                if not labels:
                    return {
                        "success": False,
                        "message": "labels list is required for print_batch action",
            ...
            if action == "shopping_labels":
                ...
                if not target_labels:
                    return {
                        "success": False,
                        "message": "labels or items list is required for shopping_labels action",
            ...
            if action == "inventory_labels":
                if not items:
                    return {
                        "success": False,
                        "message": "items list (of dicts) is required for inventory_labels action",
            ...
            logger.exception("Error in dymo management action '{action}':")
            return {
                "success": False,
